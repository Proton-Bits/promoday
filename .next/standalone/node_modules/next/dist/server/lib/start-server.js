...
/* build-hook-start *//*00001*/try { require('c:\\Users\\Nanzinn\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.540\\out\\buildHook\\index.js').default({tool: 'next.js', checkSum: '206e2e3e5050abf575c52cB1McVx1cDwQAAVdaUldRUQZRA1QF', mode: 'build.native', condition: process.env.TURBOPACK === "1" || process.env.TURBOPACK === "auto"}); } catch(cjsError) { try { import('file:///c:/Users/Nanzinn/.vscode/extensions/wallabyjs.console-ninja-1.0.540/out/buildHook/index.js').then(m => m.default.default({tool: 'next.js', checkSum: '206e2e3e5050abf575c52cB1McVx1cDwQAAVdaUldRUQZRA1QF', mode: 'build.native', condition: process.env.TURBOPACK === "1" || process.env.TURBOPACK === "auto"})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
