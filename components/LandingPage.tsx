...
import LiveStatsCycler from "./LiveStatsCycler";
...
export default function LandingPage({
  ...
  /** Slug da landing page no promozap-admin — habilita o registro real do clique. */
  slug?: string;
  fbclid?: string | null;
}>) {
  const themeStyle = {
    ...
    <>
      ...
      <section className="hero" style={themeStyle}>
        ...
        <div className="hero-inner">
          ...
          <WhatsappButton href={site.whatsappLink} trackingGroup={trackingGroup} slug={slug} fbclid={fbclid}>
